export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx3720ad9e78b4c225",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c1c2891ea76c773b91efd82031b4c66a",
  ...
  USERS: [
    {
      ...
      id: "oVCIU58ksZdPVwVrl8TN2DZuWNRI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "uLJDT_cyIsY_BjGkGks2x59J4E0g5nkFQtGdQvCuR3A",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
  ...
  CALLBACK_TEMPLATE_ID: "uLJDT_cyIsY_BjGkGks2x59J4E0g5nkFQtGdQvCuR3A",
